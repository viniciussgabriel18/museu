...
$data_inicial = isset($_GET['dataInicial']) ? $_GET['dataInicial']: "1970-01-01";
$data_final = isset ($_GET['dataFinal']) ? $_GET['dataFinal']: "2019-11-30"; 

function geraRelatorio($dbconnect, $data_inicial, $data_final) {
    $result = array ();

    $sql = "SELECT ass.nome,ass.idade,ass.instituicao,ass.profissao,ass.comentario,ass.data_cadastro,esc.descricao,ps.nome as pais,st.nome as estado,cd.nome as cidade from assinaturas as ass inner join 
